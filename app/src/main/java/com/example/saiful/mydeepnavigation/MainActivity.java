package com.example.saiful.mydeepnavigation;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AsyncCallback {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_open_detail) {
            ...
            detailIntent.putExtra(DetailActivity.EXTRA_TITLE, "Hola, Maskumambang");
            detailIntent.putExtra(DetailActivity.EXTRA_MESSAGE, "U Can Learn Android in Dicoding");
